...
execute if predicate speedrunner:0.5chance as @a at @s if block ~ ~ ~ lava run effect give @s instant_health 1 0 true
...
execute if predicate speedrunner:0.5chance as @a at @s if block ~ ~1 ~ lava run effect give @s instant_health 1 0 true
